...
namespace InteractionSystem
{
    ...
    public partial class CharacterInteractor3D : Interactor3D
    {
    	...
    	Interactable3D? _cachedClosest = null;
    	Interactable3D? _cachedRayCasted = null;
    	bool _longInteractionFinished = false;
    	...
    	public override void _Input(InputEvent @event)
    	{
    		...
    		{
    			if (LongInteractionTimer!.TimeLeft is 0)
    			{
    	...
    	void CallInteraction(bool @long = true)
    	{
    		...
    		if (IsInstanceValid(_cachedClosest) && UseAreaToInteract && InteractionOn is EAreaInteractionType.InputAction)
    		{
    			if (@long)
